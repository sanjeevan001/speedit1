...
$sql = "INSERT INTO khcoba(name,nic,occu,batch,mtype,dob,emai,ofadd,poadd,ylast,glast,reco,ypay,yexpdate)
VALUES ('{$_POST["name"]}','{$_POST["nic"]}','{$_POST["occ"]}','{$_POST["batch"]}','{$_POST["mty"]}','{$_POST["dob"]}','{$_POST["emi"]}','{$_POST["ofaddress"]}','{$_POST["poaddress"]}','{$_POST["ylast"]}','{$_POST["glast"]}','{$_POST["reco"]}','{$_POST["ypay"]}','{$_POST["yexp"]}')";
