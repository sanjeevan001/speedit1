			...
			<div id="section">
				...
				<div class="content">
					...
					<div class="lbox1">	
						...
						{
							$sql="select * from admin where TPASS='{$_POST["opass"]}' and AID='{$_SESSION["AID"]}'";
							$result=$db->query($sql);
								if($result->num_rows>0)
								{
									if($_POST["npass"]==$_POST["cpass"])
									{
										$sql="UPDATE admin SET  TPASS='{$_POST["npass"]}' where  AID='{$_SESSION["AID"]}'";
										$db->query($sql);
					...
					?>
					<form method="post" action="changepw.com">
